...
14. Execute o comando `git clone https://github.com/vamperst/FIAP-Solucoes-Multicloud.git` para clonar o repositório com os exercicios.
15. Execute o comando `cd FIAP-Solucoes-Multicloud/` para entrar na pasta criada pelo git
